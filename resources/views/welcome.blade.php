...
<div class="body-wrapper">
        ...
        <div class="ltn__header-middle-area ltn__header-sticky ltn__sticky-bg-black">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="site-logo">
                            <a href="index.html"><img src="img/Gentleman.png" alt="Logo"></a>
                        </div>
                    </div>
                        ...
                        <div class="header-menu d-none d-xl-block">
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        <li class="menu-icon"><a href="#">Ana səhifə</a></li>
                                        <li class="menu-icon"><a href="#">Haqqımızda</a></li>
                                        <li class="menu-icon"><a href="#">Məhsullar</a>
                                            <ul>
                                        ...
                                        <li class="menu-icon"><a href="#">Yeniliklər</a></li>
                    ...
                    <div class="col">
                        <div class="ltn__header-options ltn__header-options-color-white">
                            ...
                            <div class="ltn__drop-menu ltn__currency-menu">
                                <ul>
                                    <li><a href="#" class="dropdown-toggle"><span class="active-currency">AZN &#8380;</span></a>
                                        <ul>
                            ...
                            <div class="header-search-wrap">
                                ...
                                <div class="header-search-1-form">
                                    <form id="#" method="get"  action="#">
                                        <input type="text" name="search" value="" placeholder="Axtardığınız məhsulu qeyd edin..."/>
                                        <button type="submit">
    ...
    <div class="ltn__slider-area ltn__slider-4 position-relative">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white ltn__slide-animation-active">
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-7 bg-overlay-theme-black-30 bg-image" data-bg="img/slider/11.jpg">
                            ...
                            <div class="col-lg-4 offset-lg-1 col-md-7 col-sm-7 align-self-center">
                                <div class="slide-item-info text-color-white">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        <h4 class="slide-sub-title animated">Sizə necə Qulluq edək?</h4>
                                        <h1 class="slide-title animated">Saçınız tökülür?<br>Ölməmişik ki !</h1>
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-7 bg-image bg-overlay-theme-black-30" data-bg="img/slider/12.jpg">
                <div class="ltn__slide-item-inner">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-4 offset-lg-4 col-md-7 col-sm-7 align-self-center">
                                <div class="slide-item-info text-color-white">
                                    <div class="slide-item-info-inner ltn__slide-animation">
                                        <h4 class="slide-sub-title animated">Sizə necə Qulluq edək ?</h4>
                                        <h1 class="slide-title animated">Ən yaxşı brendi  <br> Özünnüz araşdırın!</h1>
                                        <div class="btn-wrapper animated">
                                            <a href="shop.html" class="btn btn-round btn-black">Shop now</a>
                                        </div>
                                    </div>
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-7 bg-image bg-overlay-theme-black-30" data-bg="img/slider/13.jpg">
                <div class="ltn__slide-item-inner">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-4 col-md-5 col-sm-5 align-self-center">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
                        <h1 class="section-title ">Məhsullarımız</h1>
                        <p>Bütün məhsullar originaldır !</p>
                    </div>
                    <div class="ltn__tab-menu ltn__tab-menu-2 ltn__tab-menu-top-right-- text-uppercase text-center">
                        <div class="nav">
                            <a class="active show" data-toggle="tab" href="#liton_tab_3_1">Populyar</a>
                            <a data-toggle="tab" href="#liton_tab_3_2" class="">Yeni</a>
                            <a data-toggle="tab" href="#liton_tab_3_3" class="">Ən çox satılan</a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-4 text-color-white text-center">
                        <h2 class="ltn__secondary-color">Super Təklif!</h2>
                        <h1 class="h1">Endirim 20% ! Təklifi dəyərləndir!</h1>
                        <p>Qeyd olunan tarix tamamlananadək  <br> Saytdan sifariş verilən seçilmiş məhsula şamil edilir</p>
                        <div class="ltn__countdown ltn__countdown-3 bg-white--" data-countdown="2022/09/01"></div>
                        <div class="btn-wrapper animated">
                            <a href="shop.html" class="theme-btn-1 btn btn-effect-1 text-uppercase">İndi sifariş et</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- PRODUCT AREA START -->
    <div class="ltn__product-area ltn__product-gutter pt-115 pb-10">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area text-center">
